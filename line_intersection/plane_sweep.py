...
class PlaneSweep(_Algorithm):
    ...
    def _check_int_event(self, l1, l2):
    ...
    def _segment_priority(self, l1: LineSegment, l2: LineSegment):
        """
    ...
    def _handle_upper_event(self, event):
        ...
        if left:
            ...
            self._comparisons.append(
                {
                    "index": (self._lines.index(event[2]),
                              self._lines.index(left)),
                    "point": int_left,
                    "sweep": self._sweep
                })
        if right:
...
if __name__ == "__main__":
    ...
    plane_sweep = PlaneSweep([l1,l2,l3])
    print(plane_sweep.run())
    pp.pprint(plane_sweep._comparisons)
